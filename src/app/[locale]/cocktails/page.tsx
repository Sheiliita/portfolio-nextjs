...
export async function generateMetadata({ params }) {
	...
	const title = messages.CocktailsPage?.pageTitle || "portfolio-nextjs Cocktail Generator";
	const description =
		messages.CocktailsPage?.pageDescription ||
		"Discover and create cocktails with portfolio-nextjs using AI-powered recipes.";
