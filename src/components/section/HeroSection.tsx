...
export function Hero() {
	...
	return (
		<section
			id="Hero"
			className="min-h-auto pt-20 pb-10 lg:py-0 lg:min-h-screen bg-contain bg-no-repeat bg-left flex flex-col items-center justify-center relative"
		>
			<div className="container mx-auto px-4">
				<div className="flex flex-col-reverse lg:flex-row justify-between items-center gap-8 lg:gap-12">
					...
					<div className="imageWrapper overflow-hidden w-full flex justify-center lg:justify-end">
						{/* Portfolio image placeholder - update as needed */}
						<Image
							...
							height={600}
							priority
							className="rounded-3xl w-full max-w-[300px] lg:!max-w-[520px] lg:max-w-none"
						/>
					</div>
