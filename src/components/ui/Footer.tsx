...
export default function Footer() {
	...
	return (
		<footer className="relative w-full ">
			<SpotlightCard
				className="w-full px-6 rounded-t-xl rounded-b-none flex flex-col items-center gap-3 lg:gap-6 h-full pb-[90px] lg:pb-0"
			...
			>
				...
				{/* Social media removed for portfolio-nextjs */}

				<div className="text-center text-sm text-gray-600 dark:text-gray-300">
					<div>
						portfolio-nextjs &copy; {new Date().getFullYear()} | {t("copyright")}.
					</div>
					<div className="mt-2">
              ...
              Cookie Settings
				...
				<div className="mt-8 InstallPrompt text-center">
					<InstallPrompt>
						<Button
							size="lg"
							className="rounded-full h-12 px-12 bg-amber-600 text-white text-md sm:text-md hover:bg-amber-700 transition-colors"
						>
